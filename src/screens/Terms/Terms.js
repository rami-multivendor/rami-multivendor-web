            ...
            <ol className={classes.boldText}>
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  ...
                  by rumi (collectively the “<b>Platforms</b>”). Please read these Terms carefully. By accessing and
                ...
                <Typography variant="subtitle2">
                  Rumi reserves the right to change or modify these Terms (including our policies which are
                ...
                <ul className={classes.bullet}>
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      Through our Platforms, rumi links you to the vendors (“<b>Vendors</b>”) for you to order a
                      ...
                      order for Goods from our Vendors (“<b>Order</b>”), rumi acts as an agent on behalf of that
              ...
              <li>
                <Typography variant="subtitle2" className={clsx(classes.boldText, classes.MV3)}>
                  Use of the Platforms and rumi Account
                </Typography>
                <Typography variant="subtitle2">
                  You will need to register for a rumi account for you to use the Platform. When you register for a
                  rumi account we will ask you to provide your personal information including a valid email address,
                  ...
                  all Orders placed under your rumi account are your sole responsibility.
                </Typography>
                <Typography variant="subtitle2" className={classes.MV3}>
                  rumi shall not be liable for Orders that encounter delivery issues due to incomplete, incorrect or
                ...
                <Typography variant="subtitle2">
                  If you wish to delete your rumi account, please send us an email requesting the same. We may
                  restrict, suspend or terminate your rumi account and/or use of the Platforms, if we reasonably
                  believe that:
                </Typography>
                <Typography variant="subtitle2" className={classes.MV3}>
                  someone other than you is using your rumi account; or
                </Typography>
                <Typography variant="subtitle2">
              ...
              <li>
                ...
                <Typography variant="subtitle2">
                  ...
                  Platforms. Rumi reserves the right to investigate and take appropriate legal action against anyone
                  who, in rumi's sole discretion, engages in any of the prohibited activities. Prohibited activities
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      ...
                      slanderous, hateful, or embarrassing to any other person or entity as determined by rumi in its
                      sole discretion or pursuant to local community standards;
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="subtitle2">
                      posting content that constitutes cyber-bullying, as determined by rumi in its sole discretion;
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="subtitle2">
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      posting anything that may be “spam,” as determined by rumi in its sole discretion;
                    </Typography>
                  </li>
                  <li>
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      ...
                      the Websites, or which, in the sole discretion of rumi, exposes rumi or any of its
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      rumi reserves the right but is not obligated to do any or all of the following:
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="subtitle2">
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      suspend or terminate a user’s access to the Platforms or their rumi Account upon any breach of
                      these Terms;
                    </Typography>
                  </li>
                  <li>
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  ...
                  rumi and/or third parties who have authorised us with the use (collectively the “<b>Trademarks</b>
                  ”). You may not use, copy, reproduce, republish, upload, post, transmit, distribute, or modify these
                  Trademarks in any way without our prior express written consent. The use of rumi's trademarks on
                  any other website not approved by us is strictly prohibited. Rumi will aggressively enforce its
                  intellectual property rights to the fullest extent of the law, including criminal prosecution. Rumi
                  neither warrants nor represents that your use of materials displayed on the Platforms will not
                  infringe rights of third parties not owned by or affiliated with rumi. Use of any materials on the
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      To purchase Alcohol, you must be of the statutory legal age. Rumi, the Vendor and their
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      To purchase Tobacco, you must be of the statutory legal age. Rumi, the Vendor and their
                      delivery riders, as the case may be, reserve the right in their sole discretion:
                    </Typography>
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  <li>
                    <Typography variant="subtitle2">
                      When you place an Order with rumi, rumi will confirm your order by sending you a
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      Special Instructions – rumi and the Vendor (as the case may be) reasonably endeavour to comply
                      with your special instructions for an Order. However in some cases where this is not feasible,
                      possible or commercially reasonable, rumi and/or the Vendor reserve the right to proceed to
                      prepare the Order in accordance with standard operating procedures. Neither rumi nor the Vendor
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      Allergens – rumi is not obligated to provide ingredient information or allergen information on
                      the Platforms. Further, rumi does not guarantee that the Goods sold by Vendors are free of
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      Rumi reserves the right to cancel any Order and/or suspend, deactivate or terminate your
                      rumi account in its sole discretion if it reasonably suspects or detects fraudulent behavior or
                      activity associated with your rumi account and/or with your Order.{" "}
                    </Typography>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      If you have existing credit in your rumi account or valid promotional or discount vouchers, you
                  ...
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      Rumi reserves the right to offer additional payment methods and/or remove existing payment
                      ...
                      provider(s) for future orders. Rumi does not store your credit card or payment information.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="subtitle2">
                      You must ensure that you have sufficient funds on your credit and debit card to fulfil payment of
                      an Order. Insofar as required, rumi takes responsibility for payments made on our Platforms
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      Rumi shall deliver your Order to the delivery address provided by You. You may choose for your
                      ...
                      ID, rumi reserves the right not to deliver your Order to you.
                    </Typography>
                  </li>
                  <li>
                    ...
                    <li>
                      ...
                      <li>
                        ...
                        <Typography variant="subtitle2" className={classes.MV2}>
                          ...
                          the Order arrives at your delivery address, rumi reserves the right to cancel the Order
                  ...
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      ...
                      indicated in Clause 1.3 above immediately. In some cases, rumi may request for photographic
                  ...
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      ...
                      event of issues or delays in your delivery. Rumi shall not be responsible in any way for Orders
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  <li>
                    <Typography variant="subtitle2">
                      From time to time, rumi may run marketing and promotional campaigns which offer voucher codes,
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      Rumi reserves the right to void, discontinue or reject the use of any Voucher without prior
                ...
                <ul className={classes.bullet}>
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      ...
                      rumi makes reasonable efforts to ensure the provision of the Platforms and the services we
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      To the extent permitted by law, rumi (which shall include its employees, directors, agents,
                      ...
                      is to discontinue your use of the Platforms. The rumi entities, their agents, representatives,
                      ...
                      losses, even if the rumi entities, their agents, representatives, and service providers have
                      ...
                      rumi, the rumi entities, its agents, representatives and service providers' liability shall
                  ...
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      Rumi shall neither be liable for actions or omissions of the Vendor nor you in regard to
                      provision of the Goods and where Vendor Delivery applies to your Order. Rumi does not assume
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  ...
                  Delivery, Vendors are responsible for delivery of the Goods and/or Orders. Rumi shall not be liable
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  You agree and consent to rumi and any of its affiliate companies collecting, using, processing and
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  You agree to indemnify, defend, hold harmless rumi, its directors, officers, employees,
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  ...
                  agree to do so at your own risk. Rumi does not control or endorse these third party websites or
                  links and shall not be responsible for the content of these linked pages. Rumi accepts no liability
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  Rumi has the right to terminate, suspend or delete your account and access to the Platforms,
                  including any delivery service we provide to you in respect of an Order, for any reason, including,
                  without limitation, if rumi, in its sole discretion, considers your use to be unacceptable, or in
                  the event of any breach by you of the Terms. Rumi may, but shall be under no obligation to, provide
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  Rumi may amend these Terms at any time in its sole discretion. The amended Terms shall be effective
