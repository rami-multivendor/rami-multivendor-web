      ...
      <Grid container item xs={12} className={classes.FAQContainer}>
        ...
        <Grid container item xs={10} sm={10} md={9}>
          <Typography variant="h4" className={classes.FAQTitle}>
            Order food online from the best restaurants and shops on Yalla
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Are you hungry? Had a long and busy day? Then Yalla is the right place for you! Yalla, offers you a long
            and detailed <b>list of the best restaurants near you</b>. Whether it is a delicious Pizza, Burger, Japanese
            or any kind of Fast Food you are craving, Yalla has an extensive roaster restaurants available for you to{" "}
          ...
          <Grid item xs={12}>
            <List disablePadding>
              ...
              <ListItem divider alignItems="flex-start" disableGutters style={{ padding: "0px", marginBottom: "10px" }}>
                ...
                <ListItemText primary="NEW: Yalla grocery delivery! Discover the best shops, pharmacies, bakeries and more near you." />
              </ListItem>
            </List>
          </Grid>
          ...
          <Typography variant="h6" className={classes.FAQTitle}>
            How can I get yalla delivery?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            To get yalla delivery, simply locate the restaurants near you by typing in your address, browse through a
          ...
          <Typography variant="h6" className={classes.FAQTitle}>
            Does yalla deliver 24 hours?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Yes, yalla in Pakistan delivers 24 hours. However, many restaurants may be unavailable for a late night
            delivery. Please check which places in Pakistan deliver to you 24 hours by using your address.
          </Typography>
          <Typography variant="h6" className={classes.FAQTitle}>
            Can you pay cash for yalla?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Yes, you can pay cash on delivery for yalla in Pakistan.
          </Typography>
          <Typography variant="h6" className={classes.FAQTitle}>
            How can I pay yalla online?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            You can pay online while ordering at yalla Pakistan by using a credit or debit card or PayPal.
          </Typography>
          <Typography variant="h6" className={classes.FAQTitle}>
            Can I order yalla for someone else?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Yes, yalla Pakistan allows you to place an order for someone else. During checkout, just update the name
          ...
          <Typography variant="h6" className={classes.FAQTitle}>
            How much does yalla charge for delivery?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Delivery fee charged by yalla in Pakistan depends on many operational factors, most of all - location and
          ...
          <Typography variant="subtitle1" className={classes.FAQAns}>
            There are hundreds of restaurants on yalla Pakistan that let you order online. For example, KFC,
